...
public enum eCoreStage {
	...
	NUKED(-90.5, 39.0, 46.5, 0f, 9),
	GOOGLEGLASS(-86.0, 33.0, 60.5, -90f, 10),
	CHEMICALS(-81.5, 45.0, 80.5, 0f, 11),
	SPIRALING(-62.5, 19.0, 104.5, 0f, 12),
	PARADOXALHALLWAY(-86.5, 19.0, 200.5, 90f, 13),
	TELEPORTER_BEFORE(-100.5, 19.82, 148.5, 180f, 14),
	TELEPORTER_AFTER(-100.5, 19.82, 148.5, 180f, 15),
